/* Generated by MyraPad at 5/17/2026 9:56:00 PM */
using Myra;
...
namespace Nursia.ActionRPG.UI
{
	partial class MainPanel: Panel
	{
		private void BuildUI()
		{
			...
			_labelPassesDrawn = new Label();
			_labelPassesDrawn.Text = "10";
			_labelPassesDrawn.Id = "_labelPassesDrawn";
			Grid.SetColumn(_labelPassesDrawn, 1);
			Grid.SetRow(_labelPassesDrawn, 4);
			...
			_panelStatistics.Widgets.Add(_labelPassesDrawn);
		...
		public Label _labelPassesDrawn;
